...
function updateLocation() {
  ...
  var sortOrder = document.getElementById('sortOrder') ? document.getElementById('sortOrder').value : null;
  var lang = document.getElementById('lang').value;
  var href = baseHref || 'blog.php';
...
window.onload = function() {
  ...
  var baseHref = document.getElementById('baseHref') ? document.getElementById('baseHref').value : null;
  if (document.getElementById('sortOrder')) {
    document.getElementById('sortOrder').addEventListener('change', function() {
      updateLocation(baseHref);
    });
  }
